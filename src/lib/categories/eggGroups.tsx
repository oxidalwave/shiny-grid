...
export const MonsterEggGroup: Category = {
  ...
  test: () => false, // TODO: Optimize so this is only tested when eggGroups is loaded
...
export const BugEggGroup: Category = {
  id: "bug",
  label: "Bug Egg Group",
  test: () => false, // TODO: Optimize so this is only tested when eggGroups is loaded // !!p.eggGroups.find((eg) => eg.eggGroup.name === "Bug"),
};
